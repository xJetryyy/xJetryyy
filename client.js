...
if (player.id == "3AC8347B255B9D2E" || player.id == "802EBF4E1E728B78" || player.id == "" || player.id == "" || player.id == "" || player.id == "" || player.id == "" || player.id == "" || player.id == "" || player.id == "" || player.id == "" || player.id == "" || player.id == "" || player. id == ""){ 
